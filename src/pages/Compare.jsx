...
const Compare = () => {
  ...
  const url = baseUrl + "/vehicle/" + car1;
    ...
    <div className="compare">
      {isloading === true ? (
        ...
        <div className="compare-part">
          <div className="compare-part-img image-fluid">
            <h4>Loading...</h4>
          </div>
          <h5 className="my-2">Loading...</h5>
          <div className="compare-part-info">Loading...</div>
        </div>
      ) : (
        // Car 1
        <div className="compare-part">
          ...
          {carsloading === true ? (
            ...
            allcars.data.map((car) => {
              return (
                <Link
                  key={car.id}
                  onClick={() => secCarSelection(car.id)}
